...
var SystemConfigMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"scalar\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"overhead\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"gasConfig\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"overhead\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"scalar\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_overhead\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"_scalar\",\"type\":\"uint256\"}],\"name\":\"setGasConfig\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
// GasConfig is a free data retrieval call binding the contract method 0x490a4432.
//
// Solidity: function gasConfig() view returns(uint256 overhead, uint256 scalar)
func (_SystemConfig *SystemConfigCaller) GasConfig(opts *bind.CallOpts) (struct {
	Overhead *big.Int
	Scalar   *big.Int
}, error) {
	var out []interface{}
	err := _SystemConfig.contract.Call(opts, &out, "gasConfig")
	...
	outstruct.Overhead = *abi.ConvertType(out[0], new(*big.Int)).(**big.Int)
	outstruct.Scalar = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
...
//
// Solidity: function gasConfig() view returns(uint256 overhead, uint256 scalar)
func (_SystemConfig *SystemConfigSession) GasConfig() (struct {
	Overhead *big.Int
	Scalar   *big.Int
}, error) {
	return _SystemConfig.Contract.GasConfig(&_SystemConfig.CallOpts)
}

// GasConfig is a free data retrieval call binding the contract method 0x490a4432.
//
// Solidity: function gasConfig() view returns(uint256 overhead, uint256 scalar)
func (_SystemConfig *SystemConfigCallerSession) GasConfig() (struct {
	Overhead *big.Int
	Scalar   *big.Int
}, error) {
	return _SystemConfig.Contract.GasConfig(&_SystemConfig.CallOpts)
